  ...
  return (
    ...
    <footer className="pt-22 px-6 md:px-20">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between">
        ...
        {/* Middle Section - Menu */}
        <div className="mb-8 md:mb-0 sm:ml-[10rem] md:ml-[15rem]">
        ...
        <div>
          ...
          <ul className="mt-2 text-graydark space-y-2 md:pb-20">
      ...
      <div className="text-[4.6rem] md:text-[18rem] font-extrabold leading-tight md:leading-50 flex justify-center items-center opacity-18 pointer-events-none select-none overflow-hidden">
        RENTACAR
      </div>
    </div>
  );
