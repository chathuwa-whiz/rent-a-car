  ...
  return (
    <div className="flex flex-row h-screen w-full pt-24">
      ...
      <div className="w-full sm:w-1/2 text-white flex flex-col justify-center items-center p-6 sm:p-10 bg-gradient-to-b from-gasolinlight to-primarybg sm:bg-none">
        ...
        <p className="sm:text-graylight mt-2 text-center sm:text-left">
          Enter your personal data to Login
        </p>

        <button className="flex items-center gap-2 border sm:border-graydark  px-6 py-2 mt-5 rounded-md w-full max-w-xs justify-center">
        ...
        <div className="flex items-center w-full max-w-xs my-5">
          ...
          <span className="sm:text-graylight px-2">Or</span>
          <hr className="flex-grow sm:border-graydark" />
        </div>

        <div className="w-full max-w-xs">
          <label className="block text-lg sm:text-graylight">Email</label>
          <input
            type="email"
      ...
      <div className="hidden sm:flex w-1/2 bg-gradient-to-b from-[#2dd6b5] via-gasolindark to-primarybgrounded-t-[50px] flex-col justify-center items-center rounded-t-4xl text-white mt-2 mr-2">
