  ...
  return (
    <div className="relative min-h-screen mb-16">
      ...
      <div className="relative w-full z-10">
        ...
        {/* "RENT A CAR" Banner */}
        <div className="absolute top-[80%] lg:top-[20%] right-[38%] lg:right-[37.5%] w-[35%] lg:w-[6%] h-[30%] lg:h-[50%] text-center 
        bg-gradient-to-r from-gasolindark to-gasolinlight lg:px-2 py-4 lg:py-12 xl:py-16 font-bold z-50">
        ...
        <div className="absolute top-[102%] lg:top-[58%] xl:top-[55%] right-[10%] md:right-[24%] xl:right-[28%] text-gasolindark font-bold z-50">
      ...
      <div className="relative py-14 ">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="mt-20 md:mt-24 lg:mt-16 ml-6 md:ml-10 xl:mt-20 xl:-ml-10">
            ...
            {/* Features Section */}
            <div className="grid grid-cols-2 md:flex md:flex-row text-graylight items-start gap-6 md:gap-10 xl:gap-20 mt-6 xl:mt-12">
          ...
          <div className="w-full lg:w-[50%] lg:h-[420px] flex justify-center lg:absolute lg:top-5 lg:right-0">
            <img
              src="/aboutus2.jpg"
              alt="Car Interior"
